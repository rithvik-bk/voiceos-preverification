 ...
 */
import { textHash } from "./provenance.js";
/** The static-fixture constructor: one utterance string → word spans with stable ids. */
export function finalizeUtterance(utteranceId, text) {
 ...
 */
export function attributeToTranscript(transcript, value) {
...
export function transcriptSource(spans, value) {
    return {
