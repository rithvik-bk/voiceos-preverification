 ...
 */
import { PreflightBlock } from "./block.js";
 ...
 */
export function clauseIndexByWord(transcript) {
    const result = [];
    let clause = 0;
...
export function parseWordIndices(spanId) {
    const indices = [];
 ...
 */
export function assertCoClausal(transcript, routing) {
...
//# sourceMappingURL=misbinding.js.map